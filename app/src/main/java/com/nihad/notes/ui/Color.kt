...
val orange200 = Color(0xFFFD8A4E)
val violet200 = Color(0xFF57314B)
val violet500 = Color(0xFF7B5D71)
val bgwhite = Color(0xFFEEEEF2)
val bgblack = Color(0xFF1A2C50)
...
//Gradient color LightTheme
val Yellow1 = Color(0xFFF6EA67)
val Yellow2 = Color(0xFFECC22E)
val Pink1 = Color(0xFFFA9DBE)
val Pink2 = Color(0xFFEF8781)
val Orange1 = Color(0xFFEB9437)
val Orange2 = Color(0xFFFF8809)
val Green1 = Color(0xFFE5FF9A)
val Green2 = Color(0xFF9DD127)
val Blue1 = Color(0xFF00F6FE)
val Blue2 = Color(0xFF51ABFE)
val Brown1 = Color(0xFFFF1B6)
val Brown2 = Color(0xFFFBC7A1)
val Cream1 = Color(0xFFFEF7F2)
val Cream2 = Color(0xFFFFE4D9)
val BlueGreenGradient1 = Color(0xFF74EBD5)
val BlueGreenGradient2 = Color(0xFF9FACE6)

val Grey1 = Color(0xFFE7F1FD)
val Grey2 = Color(0xFFC3CAD0)



//Gradient color DarkTheme
val darkYellow1 = Color(0xFFFFD96f)
val darkYellow2 = Color(0xFFD89A23)
val darkPink1 = Color(0xFFDC8875)
val darkPink2 = Color(0xFFB5304C)
val darkOrange1 = Color(0xFFF5AF19)
val darkOrange2 = Color(0xFFF12711)
val darkGreen1 = Color(0xFFB4C656)
val darkGreen2 = Color(0xFF53783B)
val darkBlue1 = Color(0xFF12D6E3)
val darkBlue2 = Color(0xFF0C5DFF)
val darkBrown1 = Color(0xFFD7C3A5)
val darkBrown2 = Color(0xFF86646C)
val darkCream1 = Color(0xFFE8A66C)
val darkCream2 = Color(0xFFD87659)
val darkBlueGreenGradient1 = Color(0xFFE0C3FC)
val darkBlueGreenGradient2 = Color(0xFF8EC5FC)
val darkGrey1 = Color(0xFF687791)
val darkGrey2 = Color(0xFF0B1D3A)
